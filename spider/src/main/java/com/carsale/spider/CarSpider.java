package com.carsale.spider;



import com.carsale.spider.pipeline.CarPipeline;
import com.carsale.spider.pipeline.ES5CarPipeline;
import com.carsale.spider.restfulpipe.RestES5;
import com.carsale.spider.restfulpipe.RestPipeline;
...
public class CarSpider implements PageProcessor{
	...
	public static void main(String[] args) {
        ...
        .addPipeline(new RestES5())
//        .addPipeline(new RestPipeline())
//        .addPipeline(new ES5CarPipeline())
